...
export class MailjetService {
  ...
  constructor(@Inject(MAILJET_CONFIG) private readonly mailjetConfig: MailjetConfig) {
  ...
  sendEmail(data: SendEmailV3_1.Body): Promise<LibraryResponse<SendEmailV3_1.Response>> {
