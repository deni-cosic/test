...
@InputType()
class FormSubmissionCreateNestedManyWithoutPatientsInput {
...
export { FormSubmissionCreateNestedManyWithoutPatientsInput as FormSubmissionCreateNestedManyWithoutPatientsInput };
