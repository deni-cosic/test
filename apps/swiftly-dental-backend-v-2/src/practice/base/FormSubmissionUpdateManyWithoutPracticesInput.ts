...
@InputType()
class FormSubmissionUpdateManyWithoutPracticesInput {
...
export { FormSubmissionUpdateManyWithoutPracticesInput as FormSubmissionUpdateManyWithoutPracticesInput };
